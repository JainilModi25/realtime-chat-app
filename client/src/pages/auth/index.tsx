import Background from "@/assets/login_logo.png"
...
const Auth = () => {
    ...
    const { setUserInfo }: any = useAppStore();
    ...
    const handleSignup = async () => {
        if(validateSignup()){
            ...
            // alert("Done signing up!")
        }
    }

    return (
        <div className="h-[100vh] w-[100vw] flex items-center justify-center font-bold">
            <div className="h-[80vh] border-2 border-white shadow-xl text-opacity-90 w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-2xl">
                    ...
                    <div className="flex items-center justify-center w-full">
                        <Tabs className="w-3/4" defaultValue="login">
                            ...
                            <TabsContent className="flex flex-col gap-5" value="signup">
                                <Input placeholder="Email" type="email" className="rounded-full p-6" value={email} onChange={(e) => setEmail(e.target.value)} />
                                <Input placeholder="Password" type="password" className="rounded-full p-6" value={password} onChange={(e) => setPassword(e.target.value)} />
                                <Input placeholder="Confirm Password" type="ConfirmPassword" className="rounded-full p-6" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} />
                ...
                <div className="hidden xl:flex mt-5 justify-center items-center">
        ...
        /*<div className="h-[100vh] w-[100vw] flex items-center justify-center">
            <div className="h-[80vh] border-0 border-white shadow-lg text-opacity-90 w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2" >
                <div className="flex flex-col gap-10 items-center justify-center" >
